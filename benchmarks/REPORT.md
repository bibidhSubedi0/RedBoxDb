...
## Latest Results (`2f22df5`)

| Metric | Value | vs Previous |
|--------|-------|-------------|
| HNSW QPS (1T) | 41,173 | +77.3% ↑ |
| HNSW QPS (12T) | 116,516 | +94.7% ↑ |
| IVF QPS (1T) | 5,953 | +34.5% ↑ |
| IVF QPS (12T) | 15,080 | +49.9% ↑ |
| HNSW Insert/sec | 2,021 | +5.7% ↑ |
| IVF Insert/sec | 78,233 | +25.7% ↑ |
| Recall@100 | 86.5% | → |
...
xychart-beta
  ...
  x-axis ["0ec05f3", "5366613", "e47eaee", "4f25193", "9d81807", "2f22df5"]
  y-axis "QPS" 0 --> 48000
  line [21803, 29297, 38537, 33923, 23225, 41173]
```
...
xychart-beta
  ...
  x-axis ["0ec05f3", "5366613", "e47eaee", "4f25193", "9d81807", "2f22df5"]
  y-axis "QPS" 0 --> 134000
  line [76009, 81296, 108905, 87655, 59834, 116516]
```
...
xychart-beta
  ...
  x-axis ["0ec05f3", "5366613", "e47eaee", "4f25193", "9d81807", "2f22df5"]
  y-axis "QPS" 0 --> 7000
  line [3457, 5074, 5151, 5312, 4427, 5953]
```
...
xychart-beta
  ...
  x-axis ["0ec05f3", "5366613", "e47eaee", "4f25193", "9d81807", "2f22df5"]
  y-axis "QPS" 0 --> 21000
  line [18039, 11386, 13485, 11521, 10058, 15080]
```
...
```
         HNSW QPS (1T)        41,173  ▁▄▇▆▁█
        HNSW QPS (12T)       116,516  ▃▄▇▄▁█
          IVF QPS (1T)         5,953  ▁▆▆▆▄█
         IVF QPS (12T)        15,080  █▂▄▂▁▆
       HNSW Insert/sec         2,021  ▁▅▇▅▇█
        IVF Insert/sec        78,233  ▁▄█▄▃█
            Recall@100         86.5%  ▁▅█▇▇▆
```
...
|---|--------|------|---------|---------|--------|--------|----------|---------|--------|
| 6 | `2f22df5` | 2026-08-03 | 41,173 | 116,516 | 5,953 | 15,080 | 2,021 | 78,233 | 86.5% |
