...
## Performance Metrics
Benchmarks run on a standard Windows workstation (100,000 vectors, Dim: 128, K=25):
* **Ingestion Throughput:** ~733,000 vectors/sec (direct) | ~1,070,000 vectors/sec (K=10)
* **Search Latency:** ~0.37ms (P50) | ~0.68ms (P99)
...
git clone https://github.com/bibidhSubedi0/RedBoxDb.git
cd RedBoxDb
# 2. Build via CMake
